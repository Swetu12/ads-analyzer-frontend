...
import { PlanFeatureSections } from "@/components/landing/IndividualPlanFeatures";
    ...
    <ReactLenis root={true}>
      <div className="relative isolate overflow-hidden">
        ...
        <main>
                ...
                {pricingData.map((plan, index) => (
                  ...
                  >
                    <PricingSection
                      ...
                      customBgColor={index === 1 ? "bg-primary/90" : ""}
          ...
          <motion.div variants={heroVariant} initial="start" animate="end">
